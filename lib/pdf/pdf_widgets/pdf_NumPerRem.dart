...
//num
  ...
  PdfTextElement(text: ':', font: contentFont).draw(
      page: page, bounds: Rect.fromLTWH(horiStartPosi, currentHeight, 0, 0))!;
  horiStartPosi = horiStartPosi + 8;
  //YN ans
  PdfTextElement(text: SPHM_Data_MAP[numVari]!, font: contentFont).draw(
      page: page, bounds: Rect.fromLTWH(horiStartPosi, currentHeight, 0, 0))!;
  horiStartPosi = horiStartPosi + 30;
  // percentage
  PdfTextElement(text: SPHM_Data_MAP[perVari]!, font: contentFont).draw(
      page: page, bounds: Rect.fromLTWH(horiStartPosi, currentHeight, 0, 0))!;
